...
<template>
  <nav
    ...
    class="bg-white font-medium text-cyan-950 fixed flex gap-4 justify-between md:justify-center items-center px-8 sm:px-16 md:px-38 lg:px-48 py-8 top-0 w-full z-20"
  >
